...
const mockConversations = [
  ...
  },
  {
    ...
    avatar: "",
    role: "doctor",
    lastMessage: "Please prepare the patient in Room 310 for surgery.",
    timestamp: "Tuesday",
    unread: 0,
    online: false
  },
...
const mockMessages = [
  {
    ...
    senderId: "nurse",
    senderName: "You",
    content: "Dr. Smith, the patient in Room 204 needs your attention. She's experiencing increased pain.",
    timestamp: "9:10 AM",
    read: true
  },
  {
    ...
    content: "Thanks for letting me know. What are her vital signs?",
    timestamp: "9:12 AM",
    read: true
  },
  {
    ...
    senderId: "nurse",
    senderName: "You",
    content: "BP 140/90, HR 95, Temp 99.1°F. She's also reporting nausea.",
    timestamp: "9:13 AM",
    read: true
  },
  {
    ...
    senderId: "doctor",
    senderName: "Dr. John Smith",
    content: "I'll be there in 10 minutes. Please administer 5mg of morphine for the pain in the meantime.",
    timestamp: "9:14 AM",
    read: true
  },
  {
    ...
    senderId: "nurse",
    senderName: "You",
    content: "Will do. I'll prepare the medication right away.",
    timestamp: "9:15 AM",
    read: true
  }
];
            ...
            <div className="flex-1 flex flex-col bg-gray-50">
              ...
              <div className="flex-1 p-4 overflow-y-auto flex flex-col gap-3">
                {messages.map((message) => (
                  <div
                    key={message.id}
                    className={`flex ${message.senderId === 'nurse' ? 'justify-end' : 'justify-start'}`}
                  >
                    <div
                      className={`max-w-[80%] rounded-lg px-4 py-2 ${
                        message.senderId === 'nurse'
